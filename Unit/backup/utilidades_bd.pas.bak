...
begin
    try
        ...
        if UTI_CN_Cerrar(param_SQLTransaction, param_SQLConnector) = False then
        begin
    ...
    try
        ...
        if var_CN_Conexion.con_Exito = True then
            ...
            begin
                ...
                var_msg.Clear;
                var_msg.Add('No existe el archivo de configuraciones');
...
begin
    try
        ...
        begin
            var_msg := TStringList.Create;
            var_msg.Clear;
            var_msg.Add('Ocurrió un error al cerrar la conexión con la BD.');
...
begin
  { ****************************************************************************
    ...
    **************************************************************************** }
    ...
    if UTI_CN_Abrir(var_SQLTransaction, var_SQLConnector) = False then Application.Terminate;
  ...
  { ****************************************************************************
    ...
    **************************************************************************** }
    ...
    if UTI_TB_Abrir( '', '', '',
                     ...
                     var_SQLQuery,
                     -1,
                    // asi me trae todos los registros de golpe
...
var var_msg : TStrings;
begin
     if UTI_TB_Cerrar(param_SQLConnector, param_SQLTransaction, param_SQLQuery) = false then
     begin
          Application.Terminate;
     end;
    ...
    try
        ...
        begin
            ...
            var_msg.Add(error.Message);
            var_msg.Add(' ');
            var_msg.Add('Y esta es la sentencia SQL:');
