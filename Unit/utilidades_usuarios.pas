...
function  UTI_usr_Existe_PWD_Ya( param_Id_Users, param_Password : String ) : Trecord_Existe;
function  UTI_usr_Existe_Menu_Ya( param_Id, param_Id_Users, param_id_Menus : String ) : Trecord_Existe;
function  UTI_usr_Existe_Menus_Permisos_Ya( param_Id, param_Id_Users, param_id_Menus, param_Tipo_CRUD : String ) : Trecord_Existe;
...
function UTI_usr_Existe_PWD_Ya( param_Id_Users,
...
begin
  ...
  { ****************************************************************************
    ...
    **************************************************************************** }
    var_SQLQuery      := TSQLQuery.Create(nil);
    var_SQLQuery.Name := 'SQLQuery_UTI_usr_Existe_PWD_Ya';
...
function UTI_usr_Existe_Menus_Permisos_Ya( param_Id,
                                           param_Id_Users,
                                           param_id_Menus,
...
begin
  ...
  { ****************************************************************************
    ...
    **************************************************************************** }
    var_SQLQuery      := TSQLQuery.Create(nil);
    var_SQLQuery.Name := 'SQLQuery_UTI_usr_Existe_Menus_Permisos_Ya';
